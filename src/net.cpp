...
void ThreadSocketHandler2(void* parg)
{
    ...
    while (true)
    {
        ...
        if (hListenSocket != INVALID_SOCKET && FD_ISSET(hListenSocket, &fdsetRecv))
        {
            ...
            else if (nInbound >= GetArg("-maxconnections", 30) - MAX_OUTBOUND_CONNECTIONS)
            {
                {
...
static const char *strDNSSeed[][2] = {
    {"vericoincore-dnsseed", "emea.vrc.vericonomy.com"},
    {"vericoincore-dnsseed", "apac.vrc.vericonomy.com"},
    {"vericoincore-dnsseed", "amer.vrc.vericonomy.com"},
};
...
void StartNode(void* parg)
{
    ...
    if (semOutbound == NULL) {
        ...
        int nMaxOutbound = min(MAX_OUTBOUND_CONNECTIONS, (int)GetArg("-maxconnections", 30));
